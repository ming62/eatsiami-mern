import { View, Platform, Image, Alert, Text, KeyboardAvoidingView, ScrollView, TextInput, TouchableOpacity, ActivityIndicator } from 'react-native';
          ...
          >
            ...
            <View style={styles.card}>
                <View style={styles.header}>
                  {/* Header */}
                  <Text style={styles.title}>Create Food Card</Text>
                  <Text style={styles.subtitle}>share your meals!</Text>
                </View>
