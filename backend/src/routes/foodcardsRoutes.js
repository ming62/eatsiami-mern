...
import {
  getAllFoodcards,
  getFoodcardsByUserId,
  getFoodcardById,
  createFoodcard,
  deleteFoodcard,
  getCurrentUserFoodcards,
  saveFoodcard,
  getSavedFoodcards,
  unsaveFoodcard
...
router.post("/", protectRoute, createFoodcard);

router.get("/", protectRoute, getAllFoodcards);

router.get("/saved-foodcards", protectRoute, getSavedFoodcards);

router.get("/user", protectRoute, getCurrentUserFoodcards);

router.get("/user/:userId", protectRoute, getFoodcardsByUserId);

router.post("/save-foodcard/:id", protectRoute, saveFoodcard);

router.delete("/unsave-foodcard/:id", protectRoute, unsaveFoodcard);

router.delete("/:id", protectRoute, deleteFoodcard);

router.get("/:id", protectRoute, getFoodcardById);
